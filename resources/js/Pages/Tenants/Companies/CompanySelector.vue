<script setup>
    ...
    // Ha van már kiválasztott cég, beállítjuk induláskor
    const selectedFromSession = computed(() => {
        return usePage().props.selected_company?.id ?? null;
    });

    selectedCompany.value = selectedFromSession.value;
